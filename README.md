...
**Moxie** is a high-performance configuration engine that treats files as dynamic templates. It decouples data storage
from file logic, ensuring thread-safe, memory-efficient, and transformable configuration management.
...
* **[a8kj7sea/a8kjCfg](https://github.com/a8kj7sea/a8kjCfg)** - My previous iteration that motivated the architectural
  improvements in Moxie.
* **[a8kj7sea/Lootboxes](https://github.com/a8kj7sea/Lootboxes)** - A previous attempt at a general configuration system
  that evolved into this project.
